...
// The per-route header bar: title and subtitle on the left; the static
// live-update dot with its label and the primary action on the right; a hairline
// bottom border. The dot is teal (interface, never status) and never animates.
export function PageHeader({ title, subtitle, updatedLabel, action }: PageHeaderProps) {
  return (
